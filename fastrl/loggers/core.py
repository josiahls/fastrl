...
# %% auto 0
__all__ = ['Record', 'LoggerBase', 'LogCollector', 'ProgressBarLogger', 'RewardCollector', 'EpocherCollector', 'BatchCollector',
...
class LoggerBase(dp.iter.IterDataPipe):
    ...
    def __init__(self,source_datapipe=None,do_filter=False):
