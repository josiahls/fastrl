...
# %% ../nbs/Fastai/00_torch_core.ipynb 4
...
# %% ../nbs/Fastai/00_torch_core.ipynb 8
defaults.benchmark = True

# %% ../nbs/Fastai/00_torch_core.ipynb 9
...
# %% ../nbs/Fastai/00_torch_core.ipynb 11
...
# %% ../nbs/Fastai/00_torch_core.ipynb 15
...
# %% ../nbs/Fastai/00_torch_core.ipynb 22
@delegates(show_image, keep=True)
def show_titled_image(o, **kwargs):
    "Call `show_image` destructuring `o` to `(img,title)`"
    show_image(o[0], title=str(o[1]), **kwargs)

# %% ../nbs/Fastai/00_torch_core.ipynb 25
@delegates(subplots)
...
# %% ../nbs/Fastai/00_torch_core.ipynb 32
...
# %% ../nbs/Fastai/00_torch_core.ipynb 40
...
# %% ../nbs/Fastai/00_torch_core.ipynb 43
...
# %% ../nbs/Fastai/00_torch_core.ipynb 49
...
# %% ../nbs/Fastai/00_torch_core.ipynb 54
@contextmanager
...
# %% ../nbs/Fastai/00_torch_core.ipynb 60
def unsqueeze(x, dim=-1, n=1):
    "Same as `torch.unsqueeze` but can add `n` dims"
    for _ in range(n): x = x.unsqueeze(dim)
    return x

# %% ../nbs/Fastai/00_torch_core.ipynb 62
...
# %% ../nbs/Fastai/00_torch_core.ipynb 67
...
# %% ../nbs/Fastai/00_torch_core.ipynb 73
...
# %% ../nbs/Fastai/00_torch_core.ipynb 75
...
# %% ../nbs/Fastai/00_torch_core.ipynb 78
def to_cpu(b):
    "Recursively map lists of tensors in `b ` to the cpu."
    return to_device(b,'cpu')

# %% ../nbs/Fastai/00_torch_core.ipynb 80
def to_np(x):
    "Convert a tensor to a numpy array."
    return apply(lambda o: o.data.cpu().numpy(), x)

# %% ../nbs/Fastai/00_torch_core.ipynb 82
...
# %% ../nbs/Fastai/00_torch_core.ipynb 88
@patch
...
# %% ../nbs/Fastai/00_torch_core.ipynb 94
...
# %% ../nbs/Fastai/00_torch_core.ipynb 110
...
# %% ../nbs/Fastai/00_torch_core.ipynb 133
def concat(*ls):
...
# %% ../nbs/Fastai/00_torch_core.ipynb 135
class Chunks:
...
# %% ../nbs/Fastai/00_torch_core.ipynb 140
...
# %% ../nbs/Fastai/00_torch_core.ipynb 142
class ShowTitle:
...
# %% ../nbs/Fastai/00_torch_core.ipynb 149
@patch
...
# %% ../nbs/Fastai/00_torch_core.ipynb 158
def find_device(b):
    "Recursively search the device of `b`."
    return item_find(b).device

# %% ../nbs/Fastai/00_torch_core.ipynb 160
def find_bs(b):
...
# %% ../nbs/Fastai/00_torch_core.ipynb 162
def np_func(f):
...
# %% ../nbs/Fastai/00_torch_core.ipynb 166
...
# %% ../nbs/Fastai/00_torch_core.ipynb 171
def one_hot(x, c):
...
# %% ../nbs/Fastai/00_torch_core.ipynb 173
...
# %% ../nbs/Fastai/00_torch_core.ipynb 176
...
# %% ../nbs/Fastai/00_torch_core.ipynb 179
...
# %% ../nbs/Fastai/00_torch_core.ipynb 181
...
# %% ../nbs/Fastai/00_torch_core.ipynb 183
@patch
...
# %% ../nbs/Fastai/00_torch_core.ipynb 189
def distrib_barrier():
...
# %% ../nbs/Fastai/00_torch_core.ipynb 193
@patch
...
# %% ../nbs/Fastai/00_torch_core.ipynb 198
...
# %% ../nbs/Fastai/00_torch_core.ipynb 200
...
# %% ../nbs/Fastai/00_torch_core.ipynb 203
...
# %% ../nbs/Fastai/00_torch_core.ipynb 206
...
# %% ../nbs/Fastai/00_torch_core.ipynb 209
def requires_grad(m):
    "Check if the first parameter of `m` requires grad or not"
    ps = list(m.parameters())
    return ps[0].requires_grad if len(ps)>0 else False

# %% ../nbs/Fastai/00_torch_core.ipynb 211
...
# %% ../nbs/Fastai/00_torch_core.ipynb 213
def cond_init(m, func):
    "Apply `init_default` to `m` unless it's a batchnorm module"
    if (not isinstance(m, norm_types)) and requires_grad(m): init_default(m, func)

# %% ../nbs/Fastai/00_torch_core.ipynb 215
def apply_leaf(m, f):
...
# %% ../nbs/Fastai/00_torch_core.ipynb 217
...
# %% ../nbs/Fastai/00_torch_core.ipynb 224
def grad_module(cls):
...
# %% ../nbs/Fastai/00_torch_core.ipynb 227
