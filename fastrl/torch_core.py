...
# %% ../nbs/00_Fastai/00_torch_core.ipynb 4
...
# %% ../nbs/00_Fastai/00_torch_core.ipynb 9
...
# %% ../nbs/00_Fastai/00_torch_core.ipynb 11
...
# %% ../nbs/00_Fastai/00_torch_core.ipynb 15
...
# %% ../nbs/00_Fastai/00_torch_core.ipynb 22
@delegates(show_image, keep=True)
def show_titled_image(o, **kwargs):
    "Call `show_image` destructuring `o` to `(img,title)`"
    show_image(o[0], title=str(o[1]), **kwargs)

# %% ../nbs/00_Fastai/00_torch_core.ipynb 25
@delegates(subplots)
...
# %% ../nbs/00_Fastai/00_torch_core.ipynb 32
...
# %% ../nbs/00_Fastai/00_torch_core.ipynb 41
...
# %% ../nbs/00_Fastai/00_torch_core.ipynb 44
...
# %% ../nbs/00_Fastai/00_torch_core.ipynb 50
...
# %% ../nbs/00_Fastai/00_torch_core.ipynb 55
@contextmanager
...
# %% ../nbs/00_Fastai/00_torch_core.ipynb 61
def unsqueeze(x, dim=-1, n=1):
    "Same as `torch.unsqueeze` but can add `n` dims"
    for _ in range(n): x = x.unsqueeze(dim)
    return x

# %% ../nbs/00_Fastai/00_torch_core.ipynb 63
...
# %% ../nbs/00_Fastai/00_torch_core.ipynb 68
...
# %% ../nbs/00_Fastai/00_torch_core.ipynb 74
...
# %% ../nbs/00_Fastai/00_torch_core.ipynb 76
...
# %% ../nbs/00_Fastai/00_torch_core.ipynb 79
def to_cpu(b):
    "Recursively map lists of tensors in `b ` to the cpu."
    return to_device(b,'cpu')

# %% ../nbs/00_Fastai/00_torch_core.ipynb 81
def to_np(x):
    "Convert a tensor to a numpy array."
    return apply(lambda o: o.data.cpu().numpy(), x)

# %% ../nbs/00_Fastai/00_torch_core.ipynb 83
...
# %% ../nbs/00_Fastai/00_torch_core.ipynb 89
@patch
...
# %% ../nbs/00_Fastai/00_torch_core.ipynb 95
...
# %% ../nbs/00_Fastai/00_torch_core.ipynb 111
...
# %% ../nbs/00_Fastai/00_torch_core.ipynb 134
def concat(*ls):
...
# %% ../nbs/00_Fastai/00_torch_core.ipynb 136
class Chunks:
...
# %% ../nbs/00_Fastai/00_torch_core.ipynb 141
...
# %% ../nbs/00_Fastai/00_torch_core.ipynb 143
class ShowTitle:
...
# %% ../nbs/00_Fastai/00_torch_core.ipynb 150
@patch
...
# %% ../nbs/00_Fastai/00_torch_core.ipynb 159
def find_device(b):
    "Recursively search the device of `b`."
    return item_find(b).device

# %% ../nbs/00_Fastai/00_torch_core.ipynb 161
def find_bs(b):
...
# %% ../nbs/00_Fastai/00_torch_core.ipynb 163
def np_func(f):
...
# %% ../nbs/00_Fastai/00_torch_core.ipynb 167
...
# %% ../nbs/00_Fastai/00_torch_core.ipynb 172
def one_hot(x, c):
...
# %% ../nbs/00_Fastai/00_torch_core.ipynb 174
...
# %% ../nbs/00_Fastai/00_torch_core.ipynb 177
...
# %% ../nbs/00_Fastai/00_torch_core.ipynb 180
...
# %% ../nbs/00_Fastai/00_torch_core.ipynb 182
...
# %% ../nbs/00_Fastai/00_torch_core.ipynb 184
@patch
...
# %% ../nbs/00_Fastai/00_torch_core.ipynb 190
def distrib_barrier():
...
# %% ../nbs/00_Fastai/00_torch_core.ipynb 194
@patch
...
# %% ../nbs/00_Fastai/00_torch_core.ipynb 199
...
# %% ../nbs/00_Fastai/00_torch_core.ipynb 201
...
# %% ../nbs/00_Fastai/00_torch_core.ipynb 204
...
# %% ../nbs/00_Fastai/00_torch_core.ipynb 207
...
# %% ../nbs/00_Fastai/00_torch_core.ipynb 210
def requires_grad(m):
    "Check if the first parameter of `m` requires grad or not"
    ps = list(m.parameters())
    return ps[0].requires_grad if len(ps)>0 else False

# %% ../nbs/00_Fastai/00_torch_core.ipynb 212
...
# %% ../nbs/00_Fastai/00_torch_core.ipynb 214
def cond_init(m, func):
    "Apply `init_default` to `m` unless it's a batchnorm module"
    if (not isinstance(m, norm_types)) and requires_grad(m): init_default(m, func)

# %% ../nbs/00_Fastai/00_torch_core.ipynb 216
def apply_leaf(m, f):
...
# %% ../nbs/00_Fastai/00_torch_core.ipynb 218
...
# %% ../nbs/00_Fastai/00_torch_core.ipynb 225
def grad_module(cls):
...
# %% ../nbs/00_Fastai/00_torch_core.ipynb 228
