# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/12m_agents.dqn.double.ipynb.

# %% auto 0
__all__ = ['DoubleQCalc', 'DQNLearner']

# %% ../nbs/12m_agents.dqn.double.ipynb 3
...
# %% ../nbs/12m_agents.dqn.double.ipynb 6
...
# %% ../nbs/12m_agents.dqn.double.ipynb 7
def DQNLearner(
    model,
    dls,
    logger_bases=None,
