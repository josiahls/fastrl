# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/12h_agents.dqn.target.ipynb.

# %% auto 0
__all__ = ['TargetQCalc', 'DQNLearner']

# %% ../nbs/12h_agents.dqn.target.ipynb 3
...
# %% ../nbs/12h_agents.dqn.target.ipynb 6
...
# %% ../nbs/12h_agents.dqn.target.ipynb 7
def DQNLearner(
    model,
    dls,
    logger_bases=None,
