...
# %% ../../../nbs/07_Agents/12l_agents.dqn.asynchronous.ipynb 9
...
# %% ../../../nbs/07_Agents/12l_agents.dqn.asynchronous.ipynb 10
def DQNLearner(
    model,
    dls,
    agent,
...
# %% ../../../nbs/07_Agents/12l_agents.dqn.asynchronous.ipynb 11
...
# %% ../../../nbs/07_Agents/12l_agents.dqn.asynchronous.ipynb 12
def DQNAgent(
    model,
    logger_bases=None,
    min_epsilon=0.02,
