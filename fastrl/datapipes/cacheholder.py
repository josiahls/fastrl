# AUTOGENERATED! DO NOT EDIT! File to edit: ../../nbs/01_DataPipes/02a_cachholder.ipynb.

# %% auto 0
__all__ = ['T_co', 'PickleableInMemoryCacheHolderIterDataPipe']

# %% ../../nbs/01_DataPipes/02a_cachholder.ipynb 2
...
# %% ../../nbs/01_DataPipes/02a_cachholder.ipynb 4
if DILL_AVAILABLE:
    import dill
