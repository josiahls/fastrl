# AUTOGENERATED! DO NOT EDIT! File to edit: nbs/02b_fastai.data.external.ipynb (unless otherwise specified).
...
def untar_data(
    ...
    d = FastDownload(fastai_cfg(), module=fastrl.fastai.data, archive=archive, data=data, base='~/.fastai')
