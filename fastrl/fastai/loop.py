...
__all__ = ['IN_IPYTHON', 'map_obj_attr2func_attr', 'isevent', 'EventException', 'grab_parent_event', 'KwargSetAttr',
           'Events', 'Event', 'EVENT_ORDER_MAPPING', 'PREFIXES', 'event', 'Loops', 'Loop', 'run_section', 'eq_loops',
           'connect_loops2loop', 'CallbackException', 'Callback', 'map_obj_attr2func_attr', 'ipy_handle_exception']
...
class Event(KwargSetAttr):
    ...
    @property
    def root_loop(self): return self.loop if self.loop.root_loop is None else self.loop.root_loop
